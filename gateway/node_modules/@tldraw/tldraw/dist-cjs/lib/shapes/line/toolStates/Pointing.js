...
class Pointing extends import_editor.StateNode {
  ...
  onEnter = (info) => {
    ...
    if (shape && inputs.shiftKey) {
      ...
      const nextPoint = import_editor.Vec2d.Sub(currentPagePoint, shapePagePoint);
      if (import_editor.Vec2d.Dist(endHandle, prevEndHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES || import_editor.Vec2d.Dist(nextPoint, endHandle) < MINIMUM_DISTANCE_BETWEEN_SHIFT_CLICKED_HANDLES) {
