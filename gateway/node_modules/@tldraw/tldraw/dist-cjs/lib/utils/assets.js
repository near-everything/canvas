...
var import_downscale = __toESM(require("downscale"));
var import_getBrowserCanvasMaxSize = require("../shapes/shared/getBrowserCanvasMaxSize");
var import_is_gif_animated = require("./assets/is-gif-animated");
...
async function getResizedImageDataUrl(dataURLForImage, width, height, opts = {}) {
  ...
  return await (0, import_downscale.default)(dataURLForImage, desiredWidth, desiredHeight, { imageType: type, quality });
}
