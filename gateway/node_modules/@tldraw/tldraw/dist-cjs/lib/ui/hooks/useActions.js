    ...
    const actionItems = [
      ...
      },
      {
        ...
        onSelect(source) {
          ...
          const offset = editor.getSelectionRotation() % (import_editor.TAU / 2);
          ...
          editor.rotateShapesBy(
            ...
            import_editor.TAU / 2 - (dontUseOffset ? 0 : offset)
          );
        }
      },
      {
        ...
        onSelect(source) {
          ...
          editor.rotateShapesBy(
            editor.getSelectedShapeIds(),
            offsetCloseToZero ? -(import_editor.TAU / 2) : -offset
          );
        }
      },
      {
        ...
        onSelect(source) {
          ...
          editor.zoomIn(editor.getViewportScreenCenter(), { duration: import_editor.ANIMATION_MEDIUM_MS });
        }
      },
      {
        id: "zoom-out",
        ...
        onSelect(source) {
          ...
          editor.zoomOut(editor.getViewportScreenCenter(), { duration: import_editor.ANIMATION_MEDIUM_MS });
        }
      },
      {
        id: "zoom-to-100",
        ...
        onSelect(source) {
          ...
          editor.resetZoom(editor.getViewportScreenCenter(), { duration: import_editor.ANIMATION_MEDIUM_MS });
        }
      },
      {
        id: "zoom-to-fit",
