...
const PageMenu = function PageMenu2() {
  ...
  const maxPageCountReached = (0, import_editor.useValue)(
    "maxPageCountReached",
    () => editor.getPages().length >= import_editor.MAX_PAGES,
    [editor]
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_Popover.Popover, { id: "pages", onOpenChange, open: isOpen, children: [
