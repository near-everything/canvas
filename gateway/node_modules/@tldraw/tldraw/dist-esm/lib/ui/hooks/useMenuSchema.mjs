...
const TLUiMenuSchemaContext = React.createContext({});
function TLUiMenuSchemaProvider({ overrides, children }) {
  ...
  return /* @__PURE__ */ jsx(TLUiMenuSchemaContext.Provider, { value: menuSchema, children });
}
...
export {
  TLUiMenuSchemaContext,
  TLUiMenuSchemaProvider,
  useMenuSchema
};
//# sourceMappingURL=useMenuSchema.mjs.map
