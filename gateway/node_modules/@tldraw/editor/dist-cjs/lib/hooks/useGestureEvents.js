  ...
  const events = React.useMemo(() => {
    ...
    const onWheel = ({ event }) => {
      ...
      const info = {
        ...
        name: "wheel",
        delta,
        point: new import_Vec2d.Vec2d(event.clientX, event.clientY).sub({
          x: container.left,
          y: container.top
        }),
    ...
    const initPointBetweenFingers = new import_Vec2d.Vec2d();
    const prevPointBetweenFingers = new import_Vec2d.Vec2d();
    ...
    const updatePinchState = (isSafariTrackpadPinch) => {
      ...
      const originDistance = import_Vec2d.Vec2d.Dist(initPointBetweenFingers, prevPointBetweenFingers);
      switch (pinchState) {
        case "not sure": {
          if (touchDistance > 24) {
            pinchState = "zooming";
