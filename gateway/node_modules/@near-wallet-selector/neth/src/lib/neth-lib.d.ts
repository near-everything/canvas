...
import type { KeyPair as NearKeyPair, Account as NearAccount } from "near-api-js";
...
export declare const getNear: () => Promise<false | {
    account: NearAccount;
    accountId: string;
    keyPair: NearKeyPair;
    secretKey: string;
}>;
export declare const signIn: () => Promise<false | {
    account: NearAccount;
    accountId: string;
    keyPair: NearKeyPair;
    secretKey: string;
